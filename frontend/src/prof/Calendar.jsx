...
import "./styles/ProfCalendar.css";
  ...
  return (
    <div className="calendar-container">
      <div className="calendar-header">
        ...
        <span>📅 Calendrier Professeur - {currentDate.toLocaleDateString("fr-FR", { month: "long", year: "numeric" })}</span>
              ...
              <div key={i} className="calendar-cell" onClick={() => day && openCreate(day)}>
                {day && <>
                  ...
                  {dayEvents.length > 1 ? (
                    ...
                    dayEvents.map(ev => (
                      <div key={ev.id} className={`calendar-event ${ev.type ? ev.type.toLowerCase().replace(' ', '-') : 'task'}`}
